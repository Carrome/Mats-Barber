...
const CACHE = "matts-flex-1789650991882";
const SHELL = [...new Set(["./", "./index.html", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png", "./assets/react-W1izUqcL.js", "./assets/icones-CGy9KHZF.js", "./assets/graficos-CVR_DiWp.js", "./assets/index-pUVVs-pr.js", "./icons/apple-touch-icon.png", "./icons/icon-192.png", "./icons/icon-512.png", "./icons/icon-maskable-512.png", "./icons/logo.png"])];
